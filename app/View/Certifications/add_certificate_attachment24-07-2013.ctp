...
function confirmFun(me)
    {
	  ...
	  if(confirm("Do You Want To Delete?"))
	  {
	       ...
	       var  uploadPath = rootpath+'Certifications/uploadimage/delete/'+encodeURIComponent(imagename);
...
function uploadFile()
     {
	  var rootpath = '<?php echo $this->webroot;?>';
	  $('#loaderRes').html('<br /><img src='+rootpath+'/app/webroot/img/ajax-loader.gif>');
	  var  uploadPath = rootpath+'Certifications/uploadimage/upload';
	  document.add_report_attachment_form.action =uploadPath;
	  document.add_report_attachment_form.target = "imgFrame";
	  document.add_report_attachment_form.submit();
     }
...
function add_certificate_attach()
{
	    ...
	    document.getElementById('loader').innerHTML='<img src="<?php echo $this->webroot; ?>img/loader.gif" />';	
	       ...
	       $.ajax({
			  type: "POST",
			  url: rootpath+"Certifications/certificateattachmentprocess/",
			  data:"data="+dataStr,
...
<?php echo $this->Element('left_menu'); ?>
 ...
 <?php
  ...
  ?>
    ...
    <?php
    echo $this->Form->create('Certifications', array('type'=>'file','id' => 'add_report_attachment_form','name'=>'add_report_attachment_form','class'=>'adminform'));
...
<div class="sub_contentwrap">
	 ...
	 <tr>
	     ...
	     <td>
		  <input type="file" name="data[Certifications][file_upload]"  id="file_upload"  /> <input type="button" name="save" id="save" class="buttonview" onclick="return uploadFile();" value="Upload" />
  ...
  <div class="sub_contentwrap fixreport_table" >
    <table width="100%" border="0" cellspacing="1" cellpadding="0" >
	  ...
	  <td colspan="3" width="100%">
	       <input type="button" name="save" id="save" class="buttonsave" onclick="add_certificate_attach();" value="<?php echo $button; ?>" /><span id="loader" style="font-size: 13px;"></span>
	  </td>
      </tr>
    </table>
 </div>
