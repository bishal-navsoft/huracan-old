...
var delete_mobile_site = "<?php echo __('Do you really want to delete this user?');?>";
var deactivate_mobile_site = "<?php echo __('Do you really want to deactivate this user?');?>";
var activate_mobile_site = "<?php echo __('Do you really want to activate this user?');?>";

var admins = "<?php echo __('User Management');?>";
var name = "<?php echo __('Email');?>";
var name_tag = "<?php echo __('[Name]');?>";
var fullname = "<?php echo __('Name');?>";
var uname = "<?php echo __('User Name');?>";
var divisionname = "<?php echo __('Division Name');?>";
var email = "<?php echo __('Email');?>";
var phone = "<?php echo __('Phone');?>";
//var position = "<?php //echo __('Position');?>";
var seniority = "<?php echo __('Seniority');?>";
var position = "<?php echo __('Position');?>";
var act = "<?php echo __('Active');?>";
var position = "<?php echo __('User Type');?>";
var inact = "<?php echo __('Inactive');?>";

 function redirect_page(){
          document.location='<?php echo $this->webroot; ?>AdminMasters/add_user';
  }

</script>
<section class="adminwrap">
<div class="topadmin_heading clearfix">
<h2>User List</h2><span id="showResponse"></span>
<?php if($is_add==1){ ?>
<input type="button" name="button" value="Add User" onclick="redirect_page();" class="buttonadmin fright" />
<?php } ?>
</div>
<div id="grid-paging" ><?php echo $this->Html->script('user_grid'); ?></div>
</section>