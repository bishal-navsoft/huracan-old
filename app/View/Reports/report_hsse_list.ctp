...
var event  = "<?php echo __('Event Date');?>";
var  closure = "<?php echo __('Closure Date');?>";
var createdby  = "<?php echo __('Created By');?>";

var summary = "<?php echo __('summary');?>";
var client = "<?php echo __('Client');?>";
var businessunit  = "<?php echo __('Business Unit');?>";
var incident_severity_name = "<?php echo __('Incident Severity');?>"; 
var remedial = "<?php echo __('Remedial C/O');?>";

var act = "<?php echo __('Active');?>";
var inact = "<?php echo __('Inactive');?>";
var login_history = "<?php echo __('Login History');?>";
var  listVal='<?php echo implode(",",$_SESSION['idBollen']);  ?>';
//var array_2 = ['a','b','c'];
...
<div id="grid-paging" ><?php echo $this->Html->script('report_grid'); ?></div>
</section>
