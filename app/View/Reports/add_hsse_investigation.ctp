...
<?php if($is_add==1){?>
<input type="button" name="button" value="<?php echo $button; ?>" class="buttonsave" onclick="add_report_investigation('<?php echo $this->webroot.'Reports/save_hsse_investigation' ?>');"  />
<?php } ?>
</div>
