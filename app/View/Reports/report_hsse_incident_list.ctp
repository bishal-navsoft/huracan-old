...
var admins = "<?php echo __('Incident Hsse Report Management');?>";

var incidentsubcategory  = "<?php echo __('Sub Category');?>";
var incidentcategory  = "<?php echo __('Category');?>";
var incidentloss  = "<?php echo __('Loss');?>";

var incidentdate  = "<?php echo __('Incident Date');?>";
var incidenttime  = "<?php echo __('Incident Time');?>";
var incidentserverity = "<?php echo __('Serverity');?>";
var report_id = "<?php echo $id; ?>";
var report_val = "<?php echo $report_id; ?>";
var incidentnumber="<?php echo __('Incident No');?>";
