...
var name_tag = "<?php echo __('[Email]');?>";
var remidial_action  = "<?php echo __('Remedial Action');?>";

var responsibility_person= "<?php echo __('Responsibility');?>";

var email_date = "<?php echo __('Send Date');?>";
var email= "<?php echo __('Email');?>"; 
var remedial_no = "<?php echo __('Remedial No');?>";
var reminder_data = "<?php echo __('Reminder Data');?>";
var create_on = "<?php echo __('Create On');?>";
 ...
 <section>
           ...
           <script language="javascript" type="text/javascript">
              $(document).ready(function() {
                  ...
                  $("#remidialemail").addClass("selectedtab");
           ...
           <h2>HSSE Report(Remedial Action Email-<?php echo $report_number; ?>) List</h2>
           
          </div>  
            

       <div id="grid-paging" ><?php echo $this->Html->script('report_hsse_remidial_email_grid'); ?></div>
 </section>
