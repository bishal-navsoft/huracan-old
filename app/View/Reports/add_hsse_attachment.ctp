...
function add_hsse_attach()
{
	   ...
	   if(attachment_description==''){
	    ...
	    if(file_name==''){
	        document.getElementById('image_upload_res').innerHTML='<span class="textcmpul">Please upload file</span>';
...
<?php echo $this->Element('left_menu'); ?>
 ...
 <?php
  ...
  ?>
    ...
    <?php
    echo $this->Form->create('Reports', array('type'=>'file','id' => 'add_report_attachment_form','name'=>'add_report_attachment_form','class'=>'adminform'));
...
<div class="upload-here">
      <input type="file" size="24"  name="data[Reports][file_upload]" id="BrowserHidden" onchange="getElementById('FileField').value = getElementById('BrowserHidden').value;" />
...
<span id="loader" style="font-size: 13px;"></span> <input type="button" name="save" id="save" class="buttonsave" onclick="add_hsse_attach();" value="<?php echo $button; ?>" />
</div>
<?php echo $this->Form->end(); ?>
</section>