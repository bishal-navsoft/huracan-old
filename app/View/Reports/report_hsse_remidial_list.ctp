...
var createon = "<?php echo __('Created On');?>";
var createby  = "<?php echo __('Created By');?>";
var remidial_action  = "<?php echo __('Remedial Action');?>";

var responsibility= "<?php echo __('Responsibility');?>";
var closedate = "<?php echo __('Closure Date');?>";
var priority = "<?php echo __('Priority');?>"; 
var lastupdate = "<?php echo __('Last Update');?>"; 
var remedial_no = "<?php echo __('Remedial No');?>";
 ...
 <section>
           ...
           <script language="javascript" type="text/javascript">
              ...
              function redirect_page(){
                 ...
                 document.location=path+"Reports/add_hsse_remidial/<?php echo base64_encode($id); ?>/";  		
           ...
           <h2>HSSE Report(Remedial-<?php echo $report_number; ?>) List</h2>
           <?php if($is_add==1){ ?>
                 <input type="button" name="button" value="Add Remedial" onclick="redirect_page();" class="buttonadmin fright" />
           <?php } ?>
          </div>  
            

       <div id="grid-paging" ><?php echo $this->Html->script('report_hsse_remidial_grid'); ?></div>
 </section>
