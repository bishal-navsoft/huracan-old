	  ...
	  <table width="100%" border="0" cellspacing="1" cellpadding="0" class="reporttableHeader">
         ...
         <table width="100%" border="0" cellspacing="1" cellpadding="0" class="reporttablewithoutborder">
                   ...
                   <tr>
                           ...
                           <td align="left"  width="28%" valign="middle" class="label1" style="border-right: 2px solid #C9A5E4;"><?php  if(isset($reportdetail[0]['SqWellData'][0])){echo $reportdetail[0]['SqWellData'][0]['rig_name_val'];}else {} ?></td>
                   </tr>
                   ...
                   <tr>
                           ...
                           <td align="left"  width="28%" valign="middle" class="label1" style="border-right: 2px solid #C9A5E4;"><?php if(isset($reportdetail[0]['IncidentSeverity'])){echo $reportdetail[0]['IncidentSeverity']['type'];}else {} ?></td>
                   </tr>
                    <tr>
...
?>
       ...
       <table width="100%" border="0" cellspacing="1" cellpadding="0" class="viewreporttable"
                ...
                <?php if($reportdetail[0]['SqInvestigation'][0]['people_title']!=''){ ?>
		 <tr>
		 ...
		 <tr>
                             <td  width="78%" class="label1">
                                   <?php echo  $reportdetail[0]['SqInvestigation'][0]['paper_description']; ?>
                             </td>
                </tr>
	       <?php }?>
        ...
        ?>
		       ...
		       <table width="100%" border="0" cellspacing="1" cellpadding="0" class="viewreporttable">
				 ...
				 <tr>
				            ...
				            <td align="left"  width="78%" valign="middle"><?php echo $reportdetail[0]['SqInvestigationData'][$i]['imd_cause_name']['0']; ?></td>
					   
				 </tr>
                                  <tr>
				            <td align="left" width="22%" valign="middle" class="label">IMMEDIATE SUB-CAUSE:</td>
				            <td align="left"  width="78%" valign="middle"><?php echo $reportdetail[0]['SqInvestigationData'][$i]['imd_sub_couse_name']['0']; ?></td>
        ...
        if(isset($reportdetail[0]['SqAttachment'][0])){?>
           ...
           <table width="100%" border="0" cellspacing="1" cellpadding="0" class="viewreporttable">
                ...
                <tr><td align="left" width="22%" valign="middle" class="label">Description</td><td align="left" width="78%" valign="middle" class="label">File Name</td></tr>    
				  ...
				  <td align="left"  width="78%" valign="middle"><a href="<?php echo $this->webroot; ?>img/file_upload/<?php echo $reportdetail[0]['SqAttachment'][$k]['file_name']; ?>" ><?php echo $reportdetail[0]['SqAttachment'][$k]['file_name'];?></a></td>
