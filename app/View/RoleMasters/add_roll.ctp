		...
		function getRollMasterData(){
			...
			document.getElementById('loader').innerHTML='<img src="<?php echo $this->webroot; ?>img/loader.gif" />';
					 ...
					 if(resD[0]=='ok'){
						...
						document.location='<?php echo $this->webroot; ?>RoleMasters/add_roll/'+resD[1];
					 }else if(resD[0]=='avl'){
...
function  pageRedrection(){
   document.location="<?php echo $this->webroot; ?>RoleMasters/add_roll";  		
...
<input type="button" name="button" value="Add Admin" onclick="pageRedrection();" class="buttonadmin fright" />
</div>
