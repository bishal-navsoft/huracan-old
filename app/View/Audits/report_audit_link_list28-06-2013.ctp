...
function add_sq_link()
    {
           	...
           	if(report_data!=0){   
                ...
                document.getElementById('res_msg').innerHTML='<img src="<?php echo $this->webroot; ?>img/loader.gif" />';	
                   ...
                   $.ajax({
                              type: "POST",
                              url: rootpath+"Audits/linkrocess/",
                              ...
                              success: function(res)
                              {
                                ...
                                if(res=='ok'){
                                       ...
                                       document.location='<?php echo $this->webroot; ?>Audits/report_audit_link_list/<?php echo $report_id_val; ?>';
                                 }else if(res=='avl'){
...
<?php echo $this->Element('left_menu'); ?>
 ...
 <section>
 <?php   echo $this->Element('audittab');    ?>
<div class="topadmin_heading clearfix">
 <?php if($is_add==1){ ?>
<h2>Audit Report(<?php echo $report_number; ?>) Link List</h2>
<?php
                 ...
                 <table width="100%" border="0" cellspacing="0" cellpadding="0"  class="dyntable">
					   ...
					   if(count($reportDeatil['JnReportMain'])>0){
                             ...
                             <td width="10%" align="right" valign="middle" >
                               <?php if($is_add==1){ ?>
                                <input type="button" name="button" value="Add" class="buttonsave" onclick="add_sq_link();" />
                                <?php } ?>
                                </td>
                           </tr>
                         </table>
...
<div id="grid-paging" ><?php  echo $this->Html->script('audit_link_grid'); ?></div>
</section>
