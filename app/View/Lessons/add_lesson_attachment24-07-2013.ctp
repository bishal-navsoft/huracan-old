...
<div class="sub_contentwrap">
	 ...
	 <tr>
	     ...
	     <td>
		  <input type="file" name="data[Lessons][file_upload]"  id="file_upload"  /> <input type="button" name="save" id="save" class="buttonview" onclick="return uploadFile();" value="Upload" />
