...
function drawDatePicker(targetDateField, x, y)
{
  ...
  //Modified on April 28,2009 - Departure Calender should show the dates according to arrival
  if(targetDateField.name == 'Departure_Date'){
	  var arrDate = getFieldDate(document.getElementById('Arrival_Date').value);
